...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get privacyPolicyIntroText =>
      'Amplio Care стремится защитить вашу конфиденциальность и данные о здоровье. Эта политика объясняет, как мы собираем, используем, храним и защищаем вашу информацию.';
  ...
  String get termsIntroText =>
      'Настоящие Условия использования («Условия») — черновик соглашения об использовании Amplio Care, iPhone-помощника реабилитационных тренировок для людей с болезнью Паркинсона. Amplio Care управляется независимым индивидуальным разработчиком. Эти Условия не заменяют профессиональную юридическую консультацию.';
  ...
  String get termsAcceptanceText =>
      'Входя в аккаунт, продолжая как гость или иным образом используя Amplio Care, вы соглашаетесь с этими Условиями и Политикой конфиденциальности. Если вы не согласны, не используйте приложение.';

  @override
  String get termsUseOfApp => 'Использование Amplio Care';

  @override
  String get termsUseOfAppText =>
      'Amplio Care предоставляет необязательные инструменты тренировки, такие как измерение тремора, голосовые упражнения, упражнения на движение, сводки прогресса и необязательный список условных названий лекарств (на устройстве для гостей; синхронизация возможна при входе).\n\nВы соглашаетесь использовать приложение только в законных личных целях и не злоупотреблять датчиками, аккаунтами или экспортированными данными способами, вредящими другим или нарушающими применимое право.';
  ...
  String get medicationDisclaimer =>
      'Список лекарств Amplio Care помогает только самостоятельно отмечать время приёма. Это не медицинская рекомендация и не содержит указаний по дозировке. В гостевом режиме данные хранятся только на этом устройстве. При входе напоминания и отметки могут синхронизироваться с вашим аккаунтом Amplio Care.';
  ...
  String get medicationNotificationPermissionNote =>
      'По желанию: разрешите уведомления, чтобы Amplio Care напоминал в заданное вами время. Уведомления остаются на этом устройстве.';
  ...
  String get reportShareFooterNote =>
      'Для каждой отправки требуется ваше подтверждение. Amplio Care не отправляет отчёты врачам автоматически.';
