...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get dataSecurityText =>
      '現行の技術スタックで利用可能な管理によりデータを保護します：\n\n• クラウド通信の TLS\n• サインインアカウントの Firebase Authentication\n• 自分のデータのみにアクセスを制限する Firestore ルール\n• アプリ内の書き出しとアカウント削除\n\n端末データベースの完全暗号化など、より強い保護は改善中であり、完了済みとは主張しません。';
  ...
  String get termsMedicalDisclaimerText =>
      'Amplio はウェルネスおよびリハビリテーション訓練の補助です。パーキンソン病やその他の疾患を診断、治療、治癒、予防しません。\n\nスコア、傾向、レポート、リマインダーは個人参照のみであり、医師、理学療法士、言語聴覚士、その他の資格ある専門家の助言に代わるものではありません。医療上の判断は専門家に相談してください。痛み、めまい、または不安全な状態を引き起こす運動は中止してください。';
