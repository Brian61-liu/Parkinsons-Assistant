...
class TrainingModuleService {
  ...
  /// 今日可执行建议：优先接已有页面的子模块（避开未审阅的步态/平衡文案任务）。
  List<ModuleTrainingTask> todaysSuggestedTasks({int count = 3}) {
    const preferred = <TrainingSubmodule>[
      TrainingSubmodule.staticControl,
      TrainingSubmodule.clarity,
      TrainingSubmodule.volume,
      TrainingSubmodule.objectHold,
      TrainingSubmodule.fineMotor,
      TrainingSubmodule.coordination,
    ];
    final picked = <ModuleTrainingTask>[];
    for (final submodule in preferred) {
      if (picked.length >= count) break;
      final tasks = generateTasksBySubmodule(
        submodule: submodule,
        count: 1,
        difficulty: 2,
      );
      if (tasks.isNotEmpty) picked.add(tasks.first);
    }
    return picked;
  }

  /// Plan / 深链：子模块对应打开哪类现有训练页。
  static String launchDomainKey(TrainingDomain domain) => domain.key;
  ...
  static const List<ModuleTrainingTask> _taskTemplates = [
    ...
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.hand,
      submodule: TrainingSubmodule.staticControl,
      title: 'Still-hand hold',
      description: 'Hold the phone still and keep your hand steady.',
      duration: 8,
      difficulty: 2,
    ),
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.hand,
      submodule: TrainingSubmodule.staticControl,
      title: 'Steady aim hold',
      description: 'Hold your wrist steady toward a fixed point.',
      duration: 10,
      difficulty: 3,
    ),
    ...
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.hand,
      submodule: TrainingSubmodule.objectHold,
      title: 'Soft-ball grip',
      description: 'Hold a soft ball with steady, moderate grip.',
      duration: 8,
      difficulty: 2,
    ),
    ModuleTrainingTask(
      ...
      submodule: TrainingSubmodule.objectHold,
      title: 'Cup transfer',
      description: 'Lift and move a cup slowly without spilling.',
      duration: 12,
      difficulty: 4,
    ),
    ...
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.hand,
      submodule: TrainingSubmodule.fineMotor,
      title: 'Finger-to-thumb taps',
      description: 'Tap each fingertip with your thumb in rhythm.',
      duration: 10,
      difficulty: 3,
    ),
    ModuleTrainingTask(
      ...
      submodule: TrainingSubmodule.fineMotor,
      title: 'Pinch pick-up',
      description: 'Pinch and pick up a small object carefully.',
      duration: 12,
      difficulty: 4,
    ),
    ...
    ModuleTrainingTask(
      ...
      submodule: TrainingSubmodule.clarity,
      title: 'Clear vowels',
      description: 'Sustain a/e/i/o/u with clear mouth shape.',
      duration: 8,
      difficulty: 2,
    ),
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.voice,
      submodule: TrainingSubmodule.clarity,
      title: 'Clear short phrases',
      description: 'Repeat a short phrase clearly, focusing on consonants.',
      duration: 10,
      difficulty: 3,
    ),
    ...
    ModuleTrainingTask(
      ...
      submodule: TrainingSubmodule.volume,
      title: 'Volume ladder',
      description: 'Raise volume step by step, then ease down.',
      duration: 8,
      difficulty: 2,
    ),
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.voice,
      submodule: TrainingSubmodule.volume,
      title: 'Steady strong voice',
      description: 'Hold a steady strong voice for short sets.',
      duration: 12,
      difficulty: 4,
    ),
    ...
    ModuleTrainingTask(
      ...
      submodule: TrainingSubmodule.fluency,
      title: 'Paced reading',
      description: 'Read along with a steady beat.',
      duration: 10,
      difficulty: 3,
    ),
    ModuleTrainingTask(
      ...
      description: 'Speak on one topic without long pauses.',
      duration: 12,
      difficulty: 4,
    ),
    ...
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.motion,
      submodule: TrainingSubmodule.balance,
      title: 'Quiet standing balance',
      description: 'Stand with feet together and stay steady.',
      duration: 8,
      difficulty: 2,
    ),
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.motion,
      submodule: TrainingSubmodule.balance,
      title: 'Side-to-side weight shift',
      description: 'Slowly shift weight left and right.',
      duration: 12,
      difficulty: 4,
    ),
    ...
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.motion,
      submodule: TrainingSubmodule.gait,
      title: 'Step rhythm practice',
      description: 'Walk to a beat with even steps.',
      duration: 10,
      difficulty: 3,
    ),
    ModuleTrainingTask(
      ...
      domain: TrainingDomain.motion,
      submodule: TrainingSubmodule.gait,
      title: 'Start-of-step cue practice',
      description: 'Use a simple cue when starting a step. Practice only — not treatment.',
      duration: 12,
      difficulty: 4,
    ),
    ...
    ModuleTrainingTask(
      ...
      description: 'Lift a knee while swinging the opposite arm.',
      duration: 10,
      difficulty: 3,
    ),
    ModuleTrainingTask(
      ...
      description: 'Alternate left/right moves on a steady rhythm.',
      duration: 15,
      difficulty: 5,
    ),
  ];
